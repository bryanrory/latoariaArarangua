// =============================================
// Admin Panel - Latoaria Ararangua
// =============================================
(function () {
  'use strict';

  // Auth check
  if (sessionStorage.getItem('lat_admin_auth') !== 'true') {
  ...
  document.getElementById('btnLogout').addEventListener('click', function () {
    sessionStorage.removeItem('lat_admin_auth');
    window.location.href = 'index.html';
  });
  ...
  async function loadEnvPhotos(envId) {
    ...
    try {
      ...
      if (!images || images.length === 0) {
        gallery.innerHTML = '<p class="no-photos">Nenhuma foto ainda. Use o botao acima para enviar fotos.</p>';
        return;
      }
