-- =============================================
-- Latoaria Ararangua - Supabase Database Setup
-- Execute este SQL no SQL Editor do Supabase
-- =============================================

-- 1. Tabela de configuracoes do site
...
-- =============================================
-- RLS (Row Level Security) - Politicas
-- =============================================
...
-- 4. Em Policies, adicione uma policy para permitir upload/leitura publica
...
VALUES (
  ...
  'SC',
  '89020-310',
  'Seg a Sex: 6h as 12h | 13h as 17h'
);
